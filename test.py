...
s.uporabniki["Špela"].seznam_projektov[0].nova_naloga(
    "igra", [2020, 7, 21], [16, 0], 5)
s.uporabniki["Špela"].nov_projekt("Izpit za avto")
s.uporabniki["Špela"].seznam_projektov[1].nova_naloga(
    "1 ura", [2020, 8, 6], [19, 38], 1)
s.uporabniki["Špela"].seznam_projektov[1].nova_naloga(
    "glavna", [2020, 8, 6], [20, 0], 3)
s.uporabniki["Špela"].seznam_projektov[0].nova_naloga(
    "servis", [2020, 8, 14], [16, 0], 4)
